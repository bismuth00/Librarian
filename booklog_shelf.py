...
class BooklogShelf(ft.Column):
    ...
    def build(self):
        ...
        self.text = ft.TextField(label="ISBN or ASIN", on_submit=lambda e: submit(e.control), min_lines=1, max_lines=5)
        self.controls.extend([
                       ...
                       ft.ResponsiveRow([
                            ...
                            ft.FilledButton("カメラ", col=1, icon=ft.Icons.COPY, on_click=lambda _: camera.test_pyocr(proc_camera)),
                            ft.FilledButton("コピー", col=1, icon=ft.Icons.COPY, on_click=lambda _: copy()),
